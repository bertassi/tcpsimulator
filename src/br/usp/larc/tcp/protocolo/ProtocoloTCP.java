...
public class ProtocoloTCP implements TCPIF {
    ...
    /** 
     * Método que recebe primitivas da camada de aplicao e executa as operaes
    ...
    /**
     * Método que abre uma nova Mquina de Estados associada a uma porta TCP
    ...
    /**
     * Método que fecha mquina de estados com id de Conexo passada como 
     * parmetro.
     *
     ...
     * @exception Exception exceção jogada quando inicializa a camada IpSimulada.
     */
     ...
     * @exception Exception exceção jogada quando a ipSimulada é fechada.
     */
    ...
    /** Método para acessar o atributo camadaIpSimulada.
    ...
    /** Método modificador do atributo camadaIpSimulada.
